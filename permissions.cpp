...
void Permissions::requestPermissions()
{
        ...
        {
            RequestPermissions = QAndroidJniObject("org/yourDiscounts/RequestPermissions",
...
void Permissions::verifyPermissionState()
{
        ...
        QAndroidJniObject stringResult = QAndroidJniObject::callStaticObjectMethod("org/yourDiscounts/RequestPermissions",
                                                                                   "getResponseState",
                                                                                   "()Ljava/lang/String;");
